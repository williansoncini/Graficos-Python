...
for repositorieDict in repositoiesDicts:
    plot_dict = {
        'value': repositorieDict['stargazers_count'],
        'label': repositorieDict['description'],
        'xlink': repositorieDict['html_url'],
    }
    plotDicts.append(plot_dict)
...
chart.add('', plotDicts)
chart.render_to_file('python_repos_dict.svg')
